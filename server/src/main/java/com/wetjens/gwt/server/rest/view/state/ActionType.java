...
public enum ActionType {
    ...
    DISCARD_1_CARD(Action.DiscardCard.Discard1Card.class, ((jsonObject, game) -> new Action.DiscardCard.Discard1Card(findCardInHand(game.currentPlayerState().getHand(), jsonObject.getJsonObject(JsonProperties.CARD))))),
    ...
    DISCARD_2_CARDS(Action.DiscardCard.Discard2Cards.class, (jsonObject, game) -> new Action.DiscardCard.Discard2Cards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    ...
    DISCARD_3_CARDS(Action.DiscardCard.Discard3Cards.class, (jsonObject, game) -> new Action.DiscardCard.Discard3Cards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    ...
    DRAW_1_CARD_THEN_DISCARD_1_CARD(Action.DrawCardThenDiscardCard.Draw1CardThenDiscard1Card.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.Draw1CardThenDiscard1Card()),
    DRAW_2_CARDS_THEN_DISCARD_2_CARDS(Action.DrawCardThenDiscardCard.Draw2CardsThenDiscard2Cards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.Draw2CardsThenDiscard2Cards()),
    ...
    DRAW_UP_TO_1_CARDS_THEN_DISCARD_CARDS(Action.DrawCardThenDiscardCard.DrawUpTo1CardsThenDiscardCards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.DrawUpTo1CardsThenDiscardCards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    DRAW_UP_TO_2_CARDS_THEN_DISCARD_CARDS(Action.DrawCardThenDiscardCard.DrawUpTo2CardsThenDiscardCards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.DrawUpTo2CardsThenDiscardCards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    DRAW_UP_TO_3_CARDS_THEN_DISCARD_CARDS(Action.DrawCardThenDiscardCard.DrawUpTo3CardsThenDiscardCards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.DrawUpTo3CardsThenDiscardCards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    DRAW_UP_TO_4_CARDS_THEN_DISCARD_CARDS(Action.DrawCardThenDiscardCard.DrawUpTo4CardsThenDiscardCards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.DrawUpTo4CardsThenDiscardCards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    DRAW_UP_TO_5_CARDS_THEN_DISCARD_CARDS(Action.DrawCardThenDiscardCard.DrawUpTo5CardsThenDiscardCards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.DrawUpTo5CardsThenDiscardCards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
    DRAW_UP_TO_6_CARDS_THEN_DISCARD_CARDS(Action.DrawCardThenDiscardCard.DrawUpTo6CardsThenDiscardCards.class, (jsonObject, game) -> new Action.DrawCardThenDiscardCard.DrawUpTo6CardsThenDiscardCards(findCardsInHand(game, jsonObject.getJsonArray(JsonProperties.CARDS)))),
