...
public enum ActionView {
    ...
    DRAW_3_CARDS_THEN_DISCARD_3_CARDS(Action.Draw3CardsThenDiscard3Cards.class),
    ...
    DRAW_2_CARDS_THEN_DISCARD_2_CARDS(Action.Draw2CardsThenDiscard2Cards.class),
    ...
    DRAW_1_CARD_THEN_DISCARD_1_CARD(Action.Draw1CardThenDiscard1Card.class),
