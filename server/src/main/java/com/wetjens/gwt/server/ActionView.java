...
public enum ActionView {
    ...
    DISCARD_1_DUTCH_BELT(Action.DiscardOneDutchBelt.class),
    ...
    DISCARD_1_JERSEY_TO_GAIN_2_DOLLARS(Action.DiscardOneJerseyToGainTwoDollars.class),
    ...
    DISCARD_1_GUERNSEY(Action.DiscardOneGuernsey.class),
    ...
    DISCARD_1_JERSEY_TO_GAIN_1_CERT(Action.DiscardOneJerseyToGainCertificate.class),
    DISCARD_1_JERSEY_TO_GAIN_4_DOLLARS(Action.DiscardOneJerseyToGainFourDollars.class),
