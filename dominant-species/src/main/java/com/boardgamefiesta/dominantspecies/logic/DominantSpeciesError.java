...
public enum DominantSpeciesError {
    ...
    INVALID_HEX,
    CANNOT_SKIP_MORE_ELEMENT_TYPES_THAN_ACTION_PAWNS_PLACED, CANNOT_MOVE_THROUGH_BLANK_HEX, INVALID_MOVE, SPECIES_MUST_BE_POSITIVE, TILE_NOT_OCCUPIED_BY_PLAYER
}
