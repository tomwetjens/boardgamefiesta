...
public enum DominantSpeciesError {
    ...
    TILE_ALREADY_SCORED,
    TILE_NOT_FOUND,
    ALREADY_TILE_AT_HEX, MUST_BE_ADJACENT_TO_TILE, NO_TILE_SELECTED, NO_TILE_AVAILABLE, MAX_DISTANCE_EXCEEDED, NOT_OPPOSING_SPECIES, DUPLICATE_TILE_TYPES, TILE_NOT_OCCUPIED_BY_PLAYER
}
